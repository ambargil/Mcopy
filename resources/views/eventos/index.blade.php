          ...
          <div class="derecha">
            ...
            <div>
              <input type="radio" id="centroMesaSi"
               name="centroMesa" value="1" >
              <label for="boquitaSi">Si</label>

              <input type="radio" id="centroMesaNo"
               name="centroMesa" value="0" checked>
